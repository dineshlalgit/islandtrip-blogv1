        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-muted-foreground text-sm md:text-base lg:text-lg">
              Discover extraordinary island destinations with IslandTrip.
              AI-powered travel planning for luxury eco-resorts, pristine
              beaches, and unforgettable adventures.
            </p>
          </div>
        </div>
        {allTags.length > 0 && (
